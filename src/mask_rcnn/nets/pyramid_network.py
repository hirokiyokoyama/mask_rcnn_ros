...
from mask_rcnn.boxes.roi import roi_cropping
from mask_rcnn.layers import anchor_encoder
from mask_rcnn.layers import anchor_decoder
from mask_rcnn.layers import roi_encoder
from mask_rcnn.layers import roi_decoder
from mask_rcnn.layers import mask_encoder
from mask_rcnn.layers import mask_decoder
from mask_rcnn.layers import gen_all_anchors
from mask_rcnn.layers import ROIAlign
from mask_rcnn.layers import ROIAlign_
from mask_rcnn.layers import sample_rpn_outputs
from mask_rcnn.layers import sample_rpn_outputs_with_gt
from mask_rcnn.layers import assign_boxes
from mask_rcnn.visualization.summary_utils import visualize_bb, visualize_final_predictions, visualize_input
...
def build_heads(pyramid, ih, iw, num_classes, base_anchors, is_training=False, gt_boxes=None):
  ...
  with slim.arg_scope(arg_scope):
    with tf.variable_scope('pyramid'):
        ...
        if gt_boxes is None:
          rois, scores, batch_inds = sample_rpn_outputs(rois, rpn_probs[:, 1], is_training=is_training)
        else:
